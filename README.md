...
This is a project for a family member, who has recently started her own business in Manicure and Facial treatments (Make-up, skin care). She wanted a professional looking website, that would show to her (potential) customers that she's knowledgeable, be able to showcase her previous work through a gallery, become a source for new customers, it has a booking page or section, and a link to her social media accounts.
...
Main color #FFBAD2 is chosen as pink. As pink represents femininity, it's also often used to market products to women and young girls. Furthermore, I've added 2 other accent colors to compliment the pink color, as seen above.
...
### User Stories ###
* As a potential customer, I want to have an easy overview of what type of treatments I could choose from, so I can make a decision about making an appointment.
...
* As a new visitor to the site, I want the site to be easy to navigate, so I can find what I was looking for in a hasty manner.
...
The Book An Appointment section, as all other sections on the page, start with a header for that section, that has a parallax scrolling effect, which is overwritten by a media query to have it set to a static image.
...
The contact form, which is currently used for bookings, has a drop down, where the (potential) customer can select a treatment. This drop down isn't required, but the remaining fields are required fields. Once the booking is received, the owner will contact the customer, to confirm appointment and discuss the options.

#### Gallery ####

The gallery section starts as with all other sections with a header, that has a parallax scrolling effect, which is overwritten by a media query to have it set to a static image for smaller size screens. The header contains heading text, to confirm that the visitor is on the correct section of the page.
...
- The Header Navigation bar including its Hamburger Menu, is visible on mobile view and larger screens including desktop view. We've kept the Hamburger Menu, to keep the design clean and minimalistic.
- We have 2 call to action buttons on the "home" section of the page, they are linked to the booking form and price list. For returning customers/visitors, they can easily book a new appointment, and for new visitors/users they can immediately click on the treatments / price list button to see the different treatments and prices that go along with those.
...
* Google Analytic - for understanding what a customer does, where they come from, and, to adjust the customers future advertisement needs (YouTube, Facebook, Groupon)
* Insert a GDPR pop-up, to notify the visitor, and, giving them the option to agree on the tracking terms, or to refuse them
* A full booking experience, where the user can select a date and slot, and, immediately pay online, guaranteeing the business owner revenue even if the person who booked the session does not show up.
* A back end to have the contact-form actually send through data to the owner. Extract e-mail address for mailing list when they opted in for the mailing list
* Fully adjusted form to compliment the website and it's colors. To have a fully responsive form, that gives feedback once the form is incorrectly filled in.
...
### User story testing ###
1. As a potential customer, I want to have an easy overview of what type of treatments I could choose from, so I can make a decision about making an appointment.
...
5. On the desktop version the user can use the arrows left and right, or click on the image and move them either left or right to scroll through the available images in the gallery section, the same behavior is used / applied in the mobile site
...
4. From here onward the user can then decide to look at further sections of the page, or scroll back up by clicking the scroll-up arrow, or to use the home button (logo top-left corner)
...
2. The correct Repository name was then added with its corresponding GitHub.io [link](https://dijkm88.github.io/ms1/ "Link to live website")
...
All digital materials have been provided by the site-owner.
...
* I used some sites for helping me choose the right color scheme:
...
* [Color Combos](https://www.colorcombos.com/color-scheme-126.html/ "Color Combinations Tester")